...
currency_wrapper3 <- function(date, full_currency_name){
  ...
  convert_money <- convert_money |>
    mutate(type = if_else(convert_money$name %in% country$isocode, "physical", "crypto"))
...
currency_trend_day <- function(date, full_currency_name){
  ...
  stop("Date out of range for api") 
    ...
    currency_trend <- currency_wrapper3(minus_7, full_currency_name)
...
currency_trend_month <- function(date, full_currency_name){
  ...
  stop("Date out of range for api") 
    ...
    currency_trend <- currency_wrapper3(minus_30, full_currency_name)
